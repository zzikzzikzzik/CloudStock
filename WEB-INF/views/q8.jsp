...
<html>
   <head>
      ...
      $(document).ready(function(){
		...
		function check(){
			...
			$.ajax({
				url : "${requestScope.croot}/q8Proc.do",
				type : "post",
				data : {answer : money},
				success : function(q8_cnt){
					if(q8_cnt == 1){
						document.goq9.submit();
					}
					else
						alert("실패")
				},
   ...
   <body id="default_theme" class="services">
     ...
     <form name="goq9" method="post" action="${requestScope.croot}/q9.do"></form> 
   </body>
</html>
